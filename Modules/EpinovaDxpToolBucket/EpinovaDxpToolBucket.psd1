@{
    ...
    FunctionsToExport = 'Invoke-DxpBlobsDownload', 'Invoke-DxpDatabaseExport', 'Invoke-DxpDatabaseDownload', 'Get-DxpStorageContainers', 'Get-DxpStorageContainerSasLink', 'Sync-DxpDbToAzure', 'Sync-DxpBlobsToAzure'
    CmdletsToExport   = @()
    AliasesToExport   = @()
}